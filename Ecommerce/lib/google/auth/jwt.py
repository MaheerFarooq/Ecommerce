...
To encode a JWT use :func:`encode`::
    ...
    from lib.lib.google.auth import crypto
    from lib.lib.google.auth import jwt
...
from lib.google.auth import crypt
from lib.google.auth import exceptions
import lib.google.auth.credentials
...
def encode(signer, payload, header=None, key_id=None):
    ...
    Args:
        signer (lib.google.auth.crypt.Signer): The signer used to sign the JWT.
...
class Credentials(lib.google.auth.credentials.Signing,
                  lib.google.auth.credentials.Credentials):
    ...
    :class:`~lib.google.auth.crypt.Signer` instance::
    ...
    def __init__(self, signer, issuer, subject, audience,
        ...
        """
        Args:
            signer (lib.google.auth.crypt.Signer): The signer used to sign JWTs.
    ...
    def _from_signer_and_info(cls, signer, info, **kwargs):
        ...
        Returns:
            lib.google.auth.jwt.Credentials: The constructed credentials.
    ...
    def from_signing_credentials(cls, credentials, audience, **kwargs):
        """Creates a new :class:`lib.google.auth.jwt.Credentials` instance from an
        existing :class:`lib.google.auth.credentials.Signing` instance.
        ...
        Args:
            credentials (lib.google.auth.credentials.Signing): The credentials to
        ...
        Returns:
            lib.google.auth.jwt.Credentials: A new Credentials instance.
        """
    ...
    @_helpers.copy_docstring(lib.google.auth.credentials.Signing)
...
class OnDemandCredentials(
        lib.google.auth.credentials.Signing,
        lib.google.auth.credentials.Credentials):
    ...
    def _from_signer_and_info(cls, signer, info, **kwargs):
        ...
        Returns:
            lib.google.auth.jwt.OnDemandCredentials: The constructed credentials.
    ...
    def from_signing_credentials(cls, credentials, **kwargs):
        """Creates a new :class:`lib.google.auth.jwt.OnDemandCredentials` instance
        from an existing :class:`lib.google.auth.credentials.Signing` instance.
    ...
    def with_claims(self, issuer=None, subject=None, additional_claims=None):
        ...
        Returns:
            lib.google.auth.jwt.OnDemandCredentials: A new credentials instance.
        """
        new_additional_claims = copy.deepcopy(self._additional_claims)
        new_additional_claims.update(additional_claims or {})
